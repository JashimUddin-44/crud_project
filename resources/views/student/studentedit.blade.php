...
<div class="container">
        <div class="row">
           <div class="col-md-12">
             <marquee behavior="scroll" scrollamount="12" direction="left"><h1>Students information Upsate</h1></marquee>
            ...
            @endif
             --}}
                ...
                <form action="{{ url('/update/'.$studentEdit->id )}}" method="POST">
                    @csrf
                    @method('PUT')
                    <!-- <input type="text" name="student_id" hidden value="{{$studentEdit->id}}">  -->
                    <div class="row">
                      <div class="col-md-6">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="number" name="registion" value="{{ $studentEdit->registion }}"registion class="form-control" id="registion" placeholder="Registion Number">
                          @error('registion')
                            <strong class="text-danger">{{ $message }}</strong>
                          @enderror
                        </div>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="password" value="{{ $studentEdit->password }}" name="password" class="form-control" id="password" placeholder="password">
                          @error('password')
                            <strong class="text-danger">{{ $message }}</strong>
                          @enderror
                        </div>
